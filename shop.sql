...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 06, 2021 lúc 08:07 AM
...
(35, 'Tông đơ điện Makita N3701 6mm (1/4 \")', NULL, 560000, 840000, 840000, 'img/elec1.jpg', '\r\nThông tin chi tiết sản phẩm\r\n\r\nSố mô hình: N3701\r\nLoại sản phẩm: 1/4 \"Tông đơ\r\nCông suất đầu vào: 440W\r\nTrọng lượng: 1,7kg\r\nTốc độ không tải: 30.000 vòng / phút\r\nDây cấp nguồn: 2,5m\r\nCơ sở: 82 x 90mm\r\nChiều dài tổng thể: 220mm\r\nKích thước Collet: 6mm (1/4 \")\r\nĐiện áp: 220V (Loại có dây / phích cắm C)\r\nVui lòng kiểm tra xem điện áp ghi trên mục có tương ứng với điện áp chính trong nhà bạn không.', 1, '2021-11-06 00:00:00'),
...
(74, 'Oto điều khiển từ xa ', 10, 30000000, 50000000, 30000000, 'img/Item_25796.jpg', 'Với động cơ V-12 769 mã lực và ngoại thất kỳ lạ, Lamborghini Aventador 2022 là định nghĩa của một chiếc siêu xe. Trong khi các đối thủ cạnh tranh như Ferrari SF90 đón nhận một tương lai điện khí hóa, thì nhà máy 12 xi-lanh của Lambo tiêu thụ nhiên liệu như một cốc bia frat bro chugs. Cửa cắt kéo của nó, tỷ lệ rộng và thấp, và thân xe có lỗ thông hơi lớn gấp đôi như một rạp hát trên bánh xe đang chiếu Fast and Furious vĩnh viễnphim. Bên trong, cabin có thể tùy chỉnh cao của nó có đủ chỗ cho hai người lái, nhưng có rất ít không gian để chứa các vật dụng rời. Phía sau tay lái, người lái có thể kích hoạt âm thanh chói tai của Aventador bằng một cú đâm của chân phải hoặc trải nghiệm sự nhanh nhẹn đáng ngạc nhiên của cỗ máy khổng lồ bằng cách xoay bánh xe. Trong khi hộp số tự động lỗi thời của nó gần như gây khó chịu như việc loại bỏ mái nhà cồng kềnh của chiếc roadster, đó chỉ là một sự đền tội nhỏ cho sức mạnh tuyệt vời và phong cách không thể nhầm lẫn của Aventador 2022.', 1, '2021-11-06 05:08:00'),
(75, 'Máy ảnh canon 60D', 10, 15000000, 25000000, 15000000, 'img/Item_26432.jpg', 'Canon 60D là dòng máy bán chuyên nhưng lại có khả năng quay phim độ nét cao 1080p. Chiếc máy này có vài tính năng của dòng máy cao cấp Canon EOS 5D Mark II, bao gồm chức năng quay phim, chức năng xem trực tiếp, và công nghệ xử lý ảnh DiGIC 4.Những đoạn phim được thu với định dạng MOV với chuẩn nén video H.264/MPEG-4 và tuyến âm thanh PCM.', 1, '2021-11-06 05:15:00');
...
--
ALTER TABLE `item`
  MODIFY `ItemID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT cho bảng `solditems`
--
ALTER TABLE `solditems`
  MODIFY `InvoiceNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
